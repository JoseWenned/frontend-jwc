...
import { ProdutosPage } from "../../../../src/presentation/pages/products/products.page";

// ==================================================
// MOCKS
// ==================================================

vi.mock("@/presentation/components/header/header.component", () => ({
    Header: () => (
...
vi.mock("@/presentation/components/footer/footer.component", () => ({
    Footer: () => (
...
vi.mock(
    "@/presentation/components/brandProducts/brandProducts.component",
    () => ({
        BrandProdutos: ({
            marca,
            produtos,
...
vi.mock(
    "@/presentation/components/sections/sectionOne/sectionOne.component",
    () => ({
        SectionOne: () => (
...
vi.mock(
    "@/presentation/fragments/buttons/buttonWhatsApp/buttonWhatsApp.component",
    () => ({
        ButtonWhatsApp: () => (
            <a
...
vi.mock("@/presentation/animations", () => ({
    fadeLeft: {},
    fadeRight: {},
    staggerContainer: {},
    orderContent: {},
