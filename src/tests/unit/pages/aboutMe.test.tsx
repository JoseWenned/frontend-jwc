...
import { SobreNosPage } from "../../../../src/presentation/pages/aboutMe/aboutMe.page";
...
vi.mock(
    "@/presentation/components/header/header.component",
    () => ({
        Header: () => (
...
vi.mock(
    "@/presentation/components/footer/footer.component",
    () => ({
        Footer: () => (
